"""
Django settings for ryan_bandwidth_test_40172 project.
...
ROOT_URLCONF = 'ryan_bandwidth_test_40172.urls'
...
WSGI_APPLICATION = 'ryan_bandwidth_test_40172.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ryan_bandwidth_test_40172 API",
    "DESCRIPTION": "API documentation for ryan_bandwidth_test_40172 App",
    "VERSION": "v1",
}
